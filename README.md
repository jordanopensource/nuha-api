...
app/
  ...
  languages.json       Language code to display name, shared across dialects
  dialects/            One self-contained file per dialect (arz/acm/ckb).json:
                       name, hf_repo, languages, preprocessing, mem_limit,
                       replicas, and labels. The single source of truth.
