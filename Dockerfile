...
# Nuha API - Dockerfile
# =============================================================================
# One stateless image for all dialects. Models stay out of the image: the
# api loads every dialect from the models volume at startup (MODELS_DIR), and
# the same image runs the models-init and fetch services that populate that
# volume. There is no ARG DIALECT and no download stage; the image is
# identical regardless of which dialects exist.
#
